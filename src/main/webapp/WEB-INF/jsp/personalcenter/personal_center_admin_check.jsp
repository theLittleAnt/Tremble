...
<head>
    ...
    <link rel="stylesheet" href="/cars-sale/static/css/personalcenter/user_apply.css">
...
<body>
    ...
    <div class="container page-container text-center">
        <jsp:include page="items/admin_check.jsp"/>
    </div>
    ...
    <script src="static/js/personalcenter/admin_check.js"></script>
</body>
</html>
